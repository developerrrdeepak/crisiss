    ...
    <div className="bg-[#f7f9ff] dark:bg-[#131313] text-[#081d2c] dark:text-zinc-50 min-h-screen font-['Outfit'] transition-colors flex flex-col">
            ...
            <Link
              ...
              className={`font-bold tracking-tight uppercase text-sm transition-all hover:-translate-y-0.5 ${
                i === 1
                  ...
                  : "text-[#414753] dark:text-zinc-50 hover:text-[#bc000a] dark:hover:text-[#ffb4aa]"
              }`}
            >
              {item.name}
            </Link>
      ...
      <main className="pt-24 pb-20 container mx-auto px-6 max-w-6xl relative z-10 flex-grow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white dark:bg-zinc-900 p-8 md:p-12 rounded-3xl shadow-[0_20px_50px_-15px_rgba(0,0,0,0.1)] dark:shadow-2xl border border-[#c1c6d5]/50 dark:border-[#5d3f3b]/20 hover:-translate-y-1 transition-transform group">
