...
export default function ContactPage() {
  return (
    <div className="bg-[#f7f9ff] dark:bg-[#131313] text-[#081d2c] dark:text-zinc-50 min-h-screen font-['Outfit'] transition-colors flex flex-col">
      ...
      <main className="pt-24 pb-20 container mx-auto px-6 max-w-7xl relative z-10 flex-grow">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
           ...
           <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl p-8 md:p-12 rounded-3xl shadow-[0_20px_50px_-15px_rgba(0,0,0,0.1)] dark:shadow-2xl border border-[#c1c6d5]/50 dark:border-[#5d3f3b]/30">
              ...
              <form className="space-y-6">
                 <div>
                   ...
                   <input 
                     type="text" 
                     className="w-full bg-[#f7f9ff] dark:bg-[#131313] border border-[#c1c6d5]/50 dark:border-[#5d3f3b]/30 focus:border-[#bc000a] dark:focus:border-[#ffb4aa] focus:ring-1 focus:ring-[#bc000a] rounded-lg p-4 text-[#081d2c] dark:text-zinc-50 outline-none transition-colors shadow-inner"
                 ...
                 <div>
                   ...
                   <textarea 
                     className="w-full bg-[#f7f9ff] dark:bg-[#131313] border border-[#c1c6d5]/50 dark:border-[#5d3f3b]/30 focus:border-[#bc000a] dark:focus:border-[#ffb4aa] focus:ring-1 focus:ring-[#bc000a] rounded-lg p-4 text-[#081d2c] dark:text-zinc-50 outline-none transition-colors shadow-inner h-32 resize-none"
           ...
           <div className="space-y-8 mt-4 lg:mt-0 font-['Space_Grotesk']">
              ...
              <div className="bg-[#f7f9ff] dark:bg-zinc-900 p-8 rounded-2xl border border-[#c1c6d5]/30 dark:border-[#5d3f3b]/20 shadow-xl group hover:-translate-y-1 transition-transform">
