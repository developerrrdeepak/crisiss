...
export default function AboutPage() {
  ...
  return (
    <div className="bg-[#f7f9ff] dark:bg-zinc-950 text-[#081d2c] dark:text-zinc-50 min-h-screen flex flex-col font-['Outfit'] transition-colors relative overflow-hidden">
        ...
        <div className="fixed inset-0 bg-[#081d2c]/80 dark:bg-black/90 backdrop-blur-xl z-[100] flex items-center justify-center p-4 animate-in fade-in duration-300">
          <div className="bg-white/90 dark:bg-[#131313]/90 backdrop-blur-3xl border border-white/50 dark:border-white/10 w-full max-w-md rounded-3xl p-8 relative shadow-[0_30px_100px_rgba(0,0,0,0.5)] transform scale-100 transition-transform">
            ...
            <div className="space-y-4 font-['Space_Grotesk']">
              <Link href="/guest-dashboard" className="flex items-center gap-4 bg-[#f7f9ff]/50 dark:bg-zinc-900/50 border border-[#c1c6d5]/50 dark:border-white/5 p-5 rounded-2xl hover:-translate-y-1 hover:shadow-lg transition-all group w-full">
                <div className="bg-[#e2efff] dark:bg-zinc-900 p-3 rounded-xl border border-white/10">
              ...
              <Link href="/staff-dashboard" className="flex items-center gap-4 bg-[#f7f9ff]/50 dark:bg-zinc-900/50 border border-[#c1c6d5]/50 dark:border-white/5 p-5 rounded-2xl hover:-translate-y-1 hover:shadow-lg transition-all group w-full">
                <div className="bg-[#fff0c8] dark:bg-zinc-900 p-3 rounded-xl border border-white/10">
              ...
              <Link href="/admin" className="flex items-center gap-4 bg-[#f7f9ff]/50 dark:bg-zinc-900/50 border border-[#c1c6d5]/50 dark:border-white/5 p-5 rounded-2xl hover:-translate-y-1 hover:shadow-lg transition-all group w-full">
                <div className="bg-[#ffdad6] dark:bg-zinc-900 p-3 rounded-xl border border-white/10">
