...
export default function GuestProfile() {
  ...
  return (
    <div className="bg-slate-50 dark:bg-[#050505] text-gray-900 dark:text-white h-screen overflow-hidden flex flex-col font-['Sora'] transition-colors relative selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black">
      ...
      <div className="flex flex-1 overflow-hidden relative z-10 pt-16">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-8 lg:p-10 max-w-[1200px] mx-auto w-full animate-in fade-in slide-in-from-bottom-2 duration-500">
          ...
          {/* Hero Profile Card */}
          <div className="mb-8 bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800/80 rounded-3xl shadow-sm dark:shadow-none overflow-hidden relative">
            {/* Cover Banner */}
            <div className="h-32 bg-gray-100 dark:bg-[#121215] relative overflow-hidden border-b border-gray-200 dark:border-zinc-800/80">
            ...
            <div className="px-6 md:px-8 pb-8 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 -mt-12 relative z-10">
              <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4 sm:gap-6">
                <div className="w-24 h-24 rounded-2xl bg-white dark:bg-zinc-950 border-4 border-[#fafafa] dark:border-[#050505] flex items-center justify-center shadow-md shrink-0 relative overflow-hidden group">
                  <div className="absolute inset-0 bg-gray-100 dark:bg-[#121215] flex items-center justify-center transition-colors group-hover:bg-gray-200 dark:group-hover:bg-zinc-900">
                ...
                <div className="pb-1">
                  ...
                  <p className="text-sm text-gray-500 dark:text-zinc-400 mt-1 flex items-center gap-2">
              ...
              <div className="flex items-center gap-3 pb-1">
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-semibold tracking-wide transition-all border ${editMode ? "bg-black text-white dark:bg-white dark:text-[#050505] border-black dark:border-white shadow-md" : "bg-white dark:bg-zinc-950 border-gray-200 dark:border-zinc-800/80 text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-[#121215]"}`}
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800/80 rounded-2xl p-6 shadow-sm dark:shadow-none">
                <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100 dark:border-zinc-800/80/50">
                  <span className="material-symbols-outlined text-[18px] text-gray-400 dark:text-zinc-500">person</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={field.label} className="group">
                      <p className="text-[10px] text-gray-500 dark:text-slate-500 uppercase font-bold tracking-widest mb-2 flex items-center gap-1.5">
                      ...
                      {editMode ? (
                        <input
                          ...
                          className="w-full bg-gray-50 dark:bg-[#121215] border border-gray-200 dark:border-zinc-800/80 rounded-lg px-4 py-2.5 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-black dark:focus:ring-white transition-shadow"
                        />
                      ) : (
              ...
              <div className="bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800/80 rounded-2xl p-6 shadow-sm dark:shadow-none">
                <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100 dark:border-zinc-800/80/50">
                  <span className="material-symbols-outlined text-[18px] text-gray-400 dark:text-zinc-500">hotel</span>
                  <h2 className="font-semibold text-sm">Current Stay Overview</h2>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="bg-gray-50 dark:bg-[#121215] rounded-xl p-5 border border-gray-200 dark:border-zinc-800/80">
                    <p className="text-[10px] text-gray-500 dark:text-slate-500 uppercase font-bold tracking-widest mb-2 flex items-center gap-1.5">
                  ...
                  <div className="bg-zinc-950 dark:bg-white rounded-xl p-5 border border-transparent shadow-md">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800/80 rounded-2xl p-6 shadow-sm dark:shadow-none">
                <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100 dark:border-zinc-800/80/50">
                  <span className="material-symbols-outlined text-[18px] text-gray-400 dark:text-zinc-500">insights</span>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={stat.label} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-[#121215] rounded-xl border border-gray-200 dark:border-zinc-800/80 hover:border-gray-300 dark:hover:border-[#3f3f46] transition-colors">
                      <div className="flex items-center gap-3">
                        <span className="material-symbols-outlined text-[18px] text-gray-500 dark:text-slate-500">{stat.icon}</span>
